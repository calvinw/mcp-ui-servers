"""
Company Selector UI FastAPI App - Separate from MCP server
...
ui_app = FastAPI(title="Company Selector UI")

# Create WebSocket manager
manager = ConnectionManager()

# Import company server functions for WebSocket handling
from company_selector_server import set_websocket_manager, handle_state_response
...
async def serve_company_interface(request: Request):
    """Serve the Company Selector interface with session ID"""
