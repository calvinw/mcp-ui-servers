...
# Create MCP server
mcp = FastMCP("CompanyToCompanyMCPServer")
...
async def set_company_info(session_id: str, company1: str, company1_year: str, company2: str, company2_year: str) -> str:
    ...
    Args:
        session_id: Required session ID to target specific browser connection
        company1: First company name (from available companies in the database)
        company1_year: Year for first company (2018-2024)
        company2: Second company name (from available companies in the database)
    ...
    # Validate years (companies will be validated by the web interface since they're dynamically loaded)
...
async def set_company1(session_id: str, company: str, year: str) -> str:
    ...
    Args:
        session_id: Required session ID to target specific browser connection
        company: Company name (from available companies in the database)
    ...
    # Validate year (company will be validated by the web interface since they're dynamically loaded)
    valid_years = ["2018", "2019", "2020", "2021", "2022", "2023", "2024"]
